...
*/
void cluster::K_medians::clusterize(data::DataProvider & providerOfData, cluster::ProvideK & providerOfK, cluster::InitiateK & initiateK, median::EvaluateMedian & median, LPCSTR input, LPCSTR output, size_t K, double eps) const {
